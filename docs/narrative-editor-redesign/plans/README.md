...
1. `docs/narrative-editor-redesign/redesign-design-recorder.md`
2. The matching section draft, for example `docs/narrative-editor-redesign/01-worldbase-and-cast.md`

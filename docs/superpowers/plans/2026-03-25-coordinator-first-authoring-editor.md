...
- Modify: `vendor/LOGOS-SPEC/04_MODULES/light-cone-collapse.md`
- Modify: `vendor/LOGOS-SPEC/04_MODULES/director-note-layer.md`
- Modify: `vendor/LOGOS-SPEC/04_MODULES/prompt-assembler.md`
- Modify: `vendor/LOGOS-SPEC/04_MODULES/narrative-router.md`
- Modify: `vendor/LOGOS-SPEC/04_MODULES/auditor.md`
- Modify: `vendor/LOGOS-SPEC/05_CONTRACTS/prompt-object-schema.yaml`
- Modify: `vendor/LOGOS-SPEC/05_CONTRACTS/audit-question-set-schema.yaml`
- Modify: `docs/narrative-editor-redesign/*.md` as implementation-confirmation updates only
...
- Modify: `vendor/LOGOS-SPEC/05_CONTRACTS/prompt-object-schema.yaml`
- Modify: `vendor/LOGOS-SPEC/05_CONTRACTS/audit-question-set-schema.yaml`
- Modify: `docs/narrative-editor-redesign/*.md` where implementation confirms or narrows a design rule
...
```bash
git add vendor/LOGOS-SPEC docs/narrative-editor-redesign
```

- [ ] **Step 8: Commit**

```bash
git add src vendor/LOGOS-SPEC docs
...
- Use the section docs under `docs/narrative-editor-redesign/` as the implementation source of truth when code needs behavior details.

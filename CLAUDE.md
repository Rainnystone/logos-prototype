...
This is the implementation repo. The design specification lives at:
  ../LOGOS-Design/LOGOS-SPEC/
...
- Never modify LOGOS-SPEC files from this repo
...
| What | Where |
|------|-------|
| Spec root | ../LOGOS-Design/LOGOS-SPEC/ |
